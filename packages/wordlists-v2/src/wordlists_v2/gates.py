"""Deck gates: same semantics as cleanroom deck_filters (v2 standalone copy) + cr-kata11."""
...
def is_katakana_continuous_surface(surface: str) -> bool:
    """True if NFKC surface is katakana-only (length >= 2), matching cr-kata body rules."""
    return _katakana_continuous_surface(surface)
